...
#and extract it to defined NFS folder for network boot on TDA4EVMX
REMOTEMACHINE="172.16.1.18"
REMOTESOURCEDIR="/home/ewdt/oe/arago/build/arago-tmp-external-arm-glibc/deploy/images/e3mn"
LOCALTARGETDIRROOTFS="/home/thomas/e3mn"
LOCALTARGETDIRKERNEL="/tftpboot/e3mn"
KERNELIMAGE="Image-e3mn.bin"
DEVICETREE="k3-j721e-common-proc-board-e3mn.dtb"
DEVICETREEOVERLAY="e3mn.dtbo"
ROOTFSIMAGE="e3mn-image-e3mn.tar.xz"
#ROOTFSIMAGE="tisdk-default-image-j7-evm.tar.xz"
MYSUPERSCRIPT="/home/thomas/deleteMe/myPersonalStartupScript.sh"
MYSUPERSCRIPTDESTINATION="$LOCALTARGETDIRROOTFS/home/root/exec-after-boot.sh"
...
echo "Local target start script $MYSUPERSCRIPTDESTINATION"
...
scp -v -r "ewdt@$REMOTEMACHINE:$REMOTESOURCEDIR/$ROOTFSIMAGE" "$LOCALTARGETDIRROOTFS"
cd "$LOCALTARGETDIRROOTFS"
tar -xvJf "$ROOTFSIMAGE"
cd -

# 2.5 Replace the exec-after-boot.sh script with our one
echo "Replacing the exec-after-boot.sh script with our own one..."
cp "$MYSUPERSCRIPT" "$MYSUPERSCRIPTDESTINATION"
